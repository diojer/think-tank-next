...
const onUpload = async (data, cookies) => {
    try {
        ...
        if (!response.ok) {
            ...
            alert("Press release successfully created.");
        }
    } catch (error) {
        alert(`Error: ${error}`)
    }
...
function UploadPressRelease() {
    const cookies = useCookies();
    return (
        <div className="upload-article-form-wrapper upload-subwrapper">
            <p className="article-table-heading upload-subheader">Upload a Press Release</p>
            <Formik
            ...
            >
                <Form className="upload-article-form">
                    ...
                    <Button type="submit">Upload Press Release</Button>
...
export default UploadPressRelease;
